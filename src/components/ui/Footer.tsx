...
const Footer = () => {
  return (
    <section
      id="footersection"
      className="lg:pt-16 lg:pb-8 bg-[rgba(18,18,18,1)] text-white grid grid-cols-12"
    >
      <div className="col-span-12 lg:col-span-8 lg:col-start-3">
        <div className="grid grid-cols-12 ">
          <div className="col-span-12 lg:col-span-4 flex flex-col justify-center items-center mr-auto">
          ...
          <div className="col-span-12 lg:col-span-8 md:px-8 md:ml-auto lg:mt-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center px-6 md:px-20">
          ...
          <div className="socialmediaicons flex gap-x-3 pt-3 pb-4 md:pb-0">
